$(document).ready(function() {
   ...
   //鼠标划过图片效果
	$(".s_xzgjImg").mouseenter(function() {
        $(this).find(".s_xzgjImg1").css("display", "block");
		$(this).find(".s_xzgjImg2").css("display", "none");
    });
	$(".s_xzgjImg").mouseleave(function() {
        $(this).find(".s_xzgjImg2").css("display", "block");
		$(this).find(".s_xzgjImg1").css("display", "none");
